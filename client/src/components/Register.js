...
<div className="bg-white lg:w-5/12 md:6/12 w-10/12 shadow-3xl">
  ...
  <div className="p-12 md:p-24">
    ...
    <div className="flex items-center text-lg mb-6 md:mb-8">
      ...
      <input value={data.username} onChange={e => setData({...data, username: e.target.value})}  id="username" className="bg-gray-200 pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="Username" />
    </div>
    ...
    <div className="flex items-center text-lg mb-6 md:mb-8">
      ...
      <input value={data.email} onChange={e => setData({...data, email: e.target.value})} id="email" className="bg-gray-200 pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="E-mail" />
    </div>
    ...
    <div className="flex items-center text-lg mb-6 md:mb-8">
      ...
      <input type="password" value={data.password} onChange={e => setData({...data, password: e.target.value})}  id="password" className="bg-gray-200 pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="Password" />
    </div>

    <button className="bg-gradient-to-b from-gray-700 to-gray-900 font-medium p-2 md:p-4 text-white uppercase w-full" onClick={handleRegister}>Register</button>
